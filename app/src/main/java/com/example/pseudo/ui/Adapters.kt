...
class ProcessingResultAdapter : ListAdapter<ProcessingResult, ProcessingResultAdapter.ViewHolder>(DiffCallback()) {
    inner class ViewHolder(private val binding: ItemProcessingResultBinding) : RecyclerView.ViewHolder(binding.root) {
...
class HistoryAdapter : ListAdapter<ImageRecord, HistoryAdapter.ViewHolder>(DiffCallback()) {
